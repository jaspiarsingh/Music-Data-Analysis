...
--Which city has the best customers? Return city with best total
SELECT billing_city, SUM(total) as invoice_total
FROM invoice
GROUP BY billing_city
ORDER BY invoice_total DESC;

-- Who is the best customer? the customer that spent the most money
...
SELECT   
	artist.artist_id,
	artist.name, 
	COUNT(artist.artist_id) AS number_songs
FROM track
...
WITH best_selling_artist AS (
	SELECT artist.artist_id artist_id, artist.name artist_name,
